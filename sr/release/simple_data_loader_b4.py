...
class SimpleDataLoaderB4:
    def __init__(self, capacity=500):
        ...
        self.yData = 1.1 * np.power(self.x1Data, 6) + 0.8*np.power(self.x2Data, 5) + 0.9*np.power(self.x3Data, 4) + 1.3*np.power(self.x1Data, 3) + 1.2*np.power(self.x2Data, 2) + 0.9*self.x3Data
        return
